...
// ComponentLoader handles config loading with XDG overlay support.
type ComponentLoader struct {
	xdgConfigHome string
	acornDir      string
}

// NewComponentLoader creates a loader with XDG-compliant paths.
...
func (l *ComponentLoader) LoadBase(component string) (*BaseConfig, error) {
	cfg := &BaseConfig{}
