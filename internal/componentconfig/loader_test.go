	...
	override := []FileConfig{
		{
			...
			Format: "json",
			Values: map[string]interface{}{"key": "override"},
		},
	}
	...
	base := []FileConfig{
		{
			Target: "/path/config",
			Format: "ghostty",
			Values: map[string]interface{}{"key": "base-value"},
		},
	}
	override := []FileConfig{
		{
			...
			Values: map[string]interface{}{"key": "override-value"},
		},
	}
...
func TestMergeFilesMultipleMixed(t *testing.T) {
	base := []FileConfig{
		...
		{Target: "/path/shared", Format: "json", Values: map[string]interface{}{"from": "base"}},
	}
	override := []FileConfig{
		{Target: "/path/config3", Format: "toml"},
		{Target: "/path/shared", Format: "ini", Values: map[string]interface{}{"from": "override"}},
	}
		...
		Files: []FileConfig{
			{
				Target: "/shared/config",
				Format: "ghostty",
				Values: map[string]interface{}{"theme": "light"},
			},
		},
	}
