...
func SelectMethod(methods map[string]componentconfig.InstallMethod, platform *Platform) (componentconfig.InstallMethod, bool) {
	...
	return componentconfig.InstallMethod{}, false
}
