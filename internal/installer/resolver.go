...
func (r *Resolver) BuildPlan(component string, cfg *componentconfig.InstallConfig) (*InstallPlan, error) {
	plan := &InstallPlan{
		Component: component,
		Platform:  *r.platform,
	}
...
func (r *Resolver) resolveTool(tool componentconfig.ToolInstall, reason string) error {
	// Check for cycles
...
func (r *Resolver) loadInstallConfig(component string) (*componentconfig.InstallConfig, error) {
