...
#
# This file defines color variables used throughout the shell configuration.
# Colors support both 256-color and truecolor (24-bit) terminals.

# Catppuccin Mocha Palette (Hex values for reference)
...
# Define colors based on terminal capability
if _has_truecolor; then
    # Truecolor (24-bit RGB) - Catppuccin Mocha exact colors
    ...
    # 256-color fallback - closest approximations
...
# Semantic color aliases for prompt
...
# LS_COLORS / LSCOLORS for Catppuccin Mocha
# macOS uses LSCOLORS (11 pairs), Linux uses LS_COLORS
case "$CURRENT_PLATFORM" in
    darwin)
        # LSCOLORS format: directory, symlink, socket, pipe, exec, block, char,
        #                  exec-setuid, exec-setgid, dir-sticky-writable, dir-writable
        # Using Catppuccin-inspired colors (uppercase = bold)
        export LSCOLORS="GxFxCxDxBxegedabagaced"
        ;;
    linux)
        # LS_COLORS for GNU ls - Catppuccin Mocha palette
        export LS_COLORS="di=1;34:ln=1;35:so=1;32:pi=33:ex=1;31:bd=34;46:cd=34;43:su=30;41:sg=30;46:tw=30;42:ow=30;43"
        ;;
esac

# Export all theme variables for subshells
